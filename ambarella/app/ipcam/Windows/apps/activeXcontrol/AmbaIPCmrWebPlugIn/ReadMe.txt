========================================================================
    ACTIVEX CONTROL DLL : AmbaIPCmrWebPlugIn Project Overview
========================================================================

ControlWizard has created this project for your AmbaIPCmrWebPlugIn ActiveX Control
...
that make up your AmbaIPCmrWebPlugIn ActiveX Control DLL.

AmbaIPCmrWebPlugIn.vcproj
...
AmbaIPCmrWebPlugIn.def
    This file contains information about the ActiveX Control DLL that
    must be provided to run with Microsoft Windows.

AmbaIPCmrWebPlugIn.idl
    This file contains the Object Description Language source code for the
    type library of your control.

AmbaIPCmrWebPlugIn.ico
    This file contains an icon that will appear in the About box.  This icon
    is included by the main resource file AmbaIPCmrWebPlugIn.rc.

/////////////////////////////////////////////////////////////////////////////
CAmbaIPCmrWebPlugInCtrl control:

AmbaIPCmrWebPlugInCtrl.h
    This file contains the declaration of the CAmbaIPCmrWebPlugInCtrl C++ class.

AmbaIPCmrWebPlugInCtrl.cpp
    This file contains the implementation of the CAmbaIPCmrWebPlugInCtrl C++ class.

AmbaIPCmrWebPlugInPropPage.h
    This file contains the declaration of the CAmbaIPCmrWebPlugInPropPage C++ class.

AmbaIPCmrWebPlugInPropPage.cpp
    This file contains the implementation of the CAmbaIPCmrWebPlugInPropPage C++ class.

CAmbaIPCmrWebPlugInCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CAmbaIPCmrWebPlugInCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file AmbaIPCmrWebPlugIn.rc.
...
stdafx.h, stdafx.cpp
    ...
    named AmbaIPCmrWebPlugIn.pch and a precompiled types (PCT) file named stdafx.obj.
