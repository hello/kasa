...
/*fix issue of NULL pointer on Ubuntu*/
#ifdef ATH6K_CONFIG_CFG80211
static void ar6000_ethtool_get_drvinfo(struct net_device *dev,
                                    struct ethtool_drvinfo *info)
{
    strcpy(info->driver, "AR6000");
    strcpy(info->version, "Olca3.1_RC.149");
    strcpy(info->fw_version, "Olca3.1_RC.149");
    strcpy(info->bus_info, "SDIO v2");
}
...
#define SKIP_LLC_LEN 8
                ...
                if (!(IEEE80211_IS_MULTICAST(multicastcheck_datap->dstMac))){
