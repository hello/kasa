...
(XIOCTL_FILTER_P2P_SUBMODE | INFRA_NETWORK | AP_NETWORK),   /* AR6000_XIOCTL_WMI_P2P_GRP_INIT */
(XIOCTL_FILTER_P2P_SUBMODE | INFRA_NETWORK | AP_NETWORK),   /* AR6000_XIOCTL_WMI_P2P_GRP_FORMATION_DONE    160 */
...
(XIOCTL_FILTER_P2P_SUBMODE | INFRA_NETWORK | AP_NETWORK),   /* AR6000_XIOCTL_WMI_P2P_GET_DEV_ADDR */
(XIOCTL_FILTER_P2P_SUBMODE | INFRA_NETWORK | AP_NETWORK),   /* AR6000_XIOCTL_WMI_P2P_SDPD_TX_CMD    170 */
(XIOCTL_FILTER_P2P_SUBMODE | INFRA_NETWORK | AP_NETWORK),   /* AR6000_XIOTCL_WMI_P2P_SD_CANCEL_REQUEST */
(0xFF),                                         /* AR6000_XIOCTL_SET_BT_HW_POWER_STATE             172  */
(0xFF),                                         /* AR6000_XIOCTL_GET_BT_HW_POWER_STATE             173  */
(0xFF),                                         /* AR6000_XIOCTL_GET_WLAN_SLEEP_STATE              174  */
(0xFF),                                         /* AR6000_XIOCTL_WMI_SET_TX_SGI_PARAM              175  */
(0xFF), /* 176 */
(0xFF), /* 177 */
(0xFF), /* 178 */
(XIOCTL_FILTER_NONP2P_SUBMODE | INFRA_NETWORK | ADHOC_NETWORK),                /* AR6000_XIOCTL_WMI_SET_WPA_OFFLOAD_STATE         179  */
(XIOCTL_FILTER_NONP2P_SUBMODE | INFRA_NETWORK | ADHOC_NETWORK),                /* AR6000_XIOCTL_WMI_SET_PASSPHRASE                180  */
(0xFF),                                         /* AR6000_XIOCTL_BMI_NVRAM_PROCESS                 181  */
(0xFF),                                         /* AR6000_XIOCTL_WMI_SET_DIVERSITY_PARAM           182  */
(0xFF), /* 183 */
(0xFF), /* 184 */
(0xFF), /* 185 */
(0xFF), /* 186 */
(XIOCTL_FILTER_NONP2P_SUBMODE | AP_NETWORK),                                   /* AR6000_XIOCTL_AP_ACS_DISABLE_HI_CHANNELS        187  */
(0xFF),                                         /* AR6000_XIOCTL_TCMD_CMDS                         188  */
(XIOCTL_FILTER_SUBMODE_DONTCARE | INFRA_NETWORK | ADHOC_NETWORK),                /* AR6000_XIOCTL_WMI_SET_EXCESS_TX_RETRY_THRES     189  */
(XIOCTL_FILTER_SUBMODE_DONTCARE | AP_NETWORK),                                   /* AR6000_XIOCTL_AP_GET_NUM_STA                    190  */
(XIOCTL_FILTER_NONP2P_SUBMODE | 0x1F),                                         /* AR6000_XIOCTL_SUSPEND_DRIVER                    191   */
(XIOCTL_FILTER_NONP2P_SUBMODE | 0x1F),                                         /* AR6000_XIOCTL_RESUME_DRIVER                     192   */
(XIOCTL_FILTER_SUBMODE_DONTCARE | INFRA_NETWORK | ADHOC_NETWORK | AP_NETWORK),  /* AR6000_XIOCTL_GET_SUBMODE                     193 */
(XIOCTL_FILTER_SUBMODE_DONTCARE | AP_NETWORK),                                  /* AR6000_XIOCTL_WMI_AP_APSD                     194 */
(0xFF),                                         /* AR6000_XIOCTL_TCMD_SETREG                       195  */
(0xFF),                                         /* AR6000_XIOCTL_GET_HT_CAP         196  */
(XIOCTL_FILTER_P2P_SUBMODE | INFRA_NETWORK | AP_NETWORK), /* 197 */
};
