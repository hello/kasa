...
#ident  "ACI $Id: //depot/sw/releases/olca3.1-RC/include/systemtools/ar6003/event.h#3 $, $Header: //depot/sw/releases/olca3.1-RC/include/systemtools/ar6003/event.h#3 $"
