...
MANLIB_API int RateCount(unsigned int rateMask, unsigned int rateMaskMcs20, unsigned int rateMaskMcs40, int *Rate);
...
MANLIB_API void DeviceTargetPowerGet(A_UINT32 devNum, int frequency, int rate, double *power);
