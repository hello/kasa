...
dhdsdio_dpc(dhd_bus_t *bus)
{
	...
	if (bus->ipend) {
		...
		test_status |= bcmsdh_cfg_read(bus->sdh, SDIO_FUNC_1, ((unsigned int)&regs->intstatus & 0xffff) + 0, NULL);
		test_status |= bcmsdh_cfg_read(bus->sdh, SDIO_FUNC_1, ((unsigned int)&regs->intstatus & 0xffff) + 1, NULL) << 8;
		test_status |= bcmsdh_cfg_read(bus->sdh, SDIO_FUNC_1, ((unsigned int)&regs->intstatus & 0xffff) + 2, NULL) << 16;
		test_status |= bcmsdh_cfg_read(bus->sdh, SDIO_FUNC_1, ((unsigned int)&regs->intstatus & 0xffff) + 3, NULL) << 24;
