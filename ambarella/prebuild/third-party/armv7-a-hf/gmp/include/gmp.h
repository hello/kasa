...
#define __GMP_CFLAGS "-O3 -g -pipe -Wall -mthumb -march=armv7-a -mtune=cortex-a9 -mlittle-endian -mfloat-abi=hard -mfpu=neon -Wa,-mimplicit-it=thumb -fPIC -mno-unaligned-access -I/usr/arm-linux-gnueabihf/thumb2/usr/include "
