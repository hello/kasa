...
#define __GMP_CFLAGS "-mthumb -march=armv7-a -mtune=cortex-a9 -mfloat-abi=hard -mfpu=neon -Wa,-mimplicit-it=thumb -O3 -D_FILE_OFFSET_BITS=64 -fpic -fPIC -mno-unaligned-access"
