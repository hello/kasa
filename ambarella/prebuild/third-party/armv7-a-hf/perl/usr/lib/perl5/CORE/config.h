 ...
 * Configuration time: 2014年 01月 17日 星期五 14:30:21 CST
 * Configured by     : Ambarella Shanghai, Inc.
...
#define	PERL_TARGETARCH	"arm-linux-gnueabihf"	/**/
#endif
 ...
 *	instance.
 */
#define ARCHNAME "armv7-a-linux-thread-multi"		/**/
...
#define GETGRENT_R_PROTO I_SBIR	   /**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl5"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl5"		/**/
