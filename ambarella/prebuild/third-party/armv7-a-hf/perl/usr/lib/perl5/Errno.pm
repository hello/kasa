...
"armv7-a-linux-thread-multi-3.8.8+" or
	die "Errno architecture (armv7-a-linux-thread-multi-3.8.8+) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
