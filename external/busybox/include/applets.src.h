...
IF_AMBA_DEBUG(APPLET(amba_debug, BB_DIR_BIN, BB_SUID_DROP))
...
IF_DSPLOG(APPLET(dsplog, BB_DIR_BIN, BB_SUID_DROP))
IF_DSPLOG2(APPLET(dsplog2, BB_DIR_BIN, BB_SUID_DROP))
...
IF_LOAD_UCODE(APPLET(load_ucode, BB_DIR_BIN, BB_SUID_DROP))
...
IF_NANDDUMP(APPLET(nanddump, BB_DIR_USR_SBIN, BB_SUID_DROP))
IF_NANDWRITE(APPLET(nandwrite, BB_DIR_USR_SBIN, BB_SUID_DROP))
IF_EMMCWRITE(APPLET(emmcwrite, BB_DIR_USR_SBIN, BB_SUID_DROP))
